...
# Référence vers l'overlay Game Over / Victoire (injecté depuis battle.gd ou trouvé en scène)
var game_result_ui: CanvasLayer = null
...
func _ready() -> void:
	...
	# Cherche l'overlay dans la scène battle (CanvasLayer/GameResult)
